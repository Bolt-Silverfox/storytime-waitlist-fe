...
const resourcesData: {
  ...
  },
  {
    ...
    id: 4,
    description: [
     "Most parents worry about screen time and for good reason. Fast-paced videos can overstimulate kids, shorten attention spans, and leave them wanting “more and more.” A children’s storytelling app creates the opposite effect. Story Time for Kids encourages slower thinking, deeper focus, and imagination, giving you healthy screen time that feels purposeful rather than passive.",
