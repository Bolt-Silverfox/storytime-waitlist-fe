  ...
  return (
    <div className="flex-1 flex flex-col items-center">
      ...
      <ul className="mt-12 grid grid-cols-2 lg:flex gap-12 text-[15px]  leading-9 font-abezee text-[#3F1102]">
        <li className="min-w-[132px] h-10 bg-[#EC4007] text-white rounded-[20px] px-[21px] py-1 cursor-pointer">For Parents</li>
        <li className="min-w-[132px] h-10 bg-[#E8E4E4] rounded-[20px] px-[21px] py-1 cursor-pointer">Using the app</li>
        <li className="min-w-[132px] h-10 bg-[#E8E4E4] rounded-[20px] px-[21px] py-1 cursor-pointer">Stories and audio</li>
        <li className="min-w-[132px] h-10 bg-[#E8E4E4] rounded-[20px] px-[21px] py-1 cursor-pointer">Safety and privacy</li>
        <li className="min-w-[132px] h-10 bg-[#E8E4E4] rounded-[20px] px-[21px] py-1 cursor-pointer">Subscription and billing</li>
      </ul>
