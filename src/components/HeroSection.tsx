...
const HeroSection = ({
  setIsWaitlistOverLayOpen,
}: {
  setIsWaitlistOverLayOpen: React.Dispatch<React.SetStateAction<boolean>>;
}) => {
  return (
    <div className="font-Qilka clip-top min-h-[130vh] min-w-full flex-col bg-[url('/hero-bg.png')] bg-cover bg-center bg-no-repeat">
