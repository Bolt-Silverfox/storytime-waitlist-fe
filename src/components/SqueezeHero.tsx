    ...
    <section className="relative" aria-labelledby="Hero section">
      <div className="z-20 mx-auto flex min-h-[90vh] flex-col items-center justify-center gap-8 px-5 pb-28 md:min-h-screen md:max-w-[1400px] md:flex-row md:items-center md:justify-between md:gap-12 lg:min-h-[70vh] lg:px-10">
        <div className="flex-1 text-center md:text-left">
          <h1 className="font-Qilka text-3xl leading-tight font-bold text-[#231F1E] not-italic md:text-5xl lg:text-[4rem] lg:leading-none">
            <span className="inline-flex items-center gap-2">
              Better{" "}
              <motion.img
                src={mila}
                alt="MILA book cover"
                className="inline-block h-auto w-auto drop-shadow-lg"
          ...
          <p className="font-abezee w-full pt-4 text-base leading-7 font-normal text-[#4F4C4B] not-italic md:w-[90%] md:pt-6 md:text-xl md:leading-8">
          ...
          <div className="relative z-20 mt-6 flex flex-col gap-4 sm:flex-row md:mt-[2.81rem]">
            <button
              ...
              className="font-abezee cursor-pointer rounded-[6.25rem] bg-[#EC4007] px-6 py-2.5 text-lg leading-[2.26325rem] font-normal text-white not-italic transition-all hover:bg-[#d13706] md:px-8 md:text-xl"
            >
              Join Early Access
            </button>
            <button
              onClick={handleDownloadClick}
              className="font-abezee cursor-pointer rounded-[6.25rem] border border-solid border-[#EC4007] px-6 py-2.5 text-lg leading-[2.26325rem] font-normal text-[#EC4007] not-italic transition-all hover:bg-[#EC4007] hover:text-white md:px-8 md:text-xl"
            >
              Download App
            </button>
          </div>
