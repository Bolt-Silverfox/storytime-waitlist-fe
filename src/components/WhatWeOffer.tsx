...
export default function WhatWeOffer() {
  ...
  return (
    <section className="mt-20 md:mt-40">
      ...
      <div className="no-scrollbar flex snap-x snap-mandatory gap-4 overflow-x-auto scroll-smooth px-4 pb-4 lg:hidden">
        {features.map((feature, index) => (
          <motion.div
            ...
            className="mx-auto flex w-full min-w-[320px] shrink-0 snap-center flex-col justify-between rounded-[31.28px] px-6 py-10 shadow-lg md:h-[520px] md:min-w-[380px] md:p-8"
      ...
      {/* Grid for desktop */}
      <div className="mx-auto hidden max-w-7xl grid-cols-3 gap-[25px] px-6 lg:grid">
        {features.map((feature, index) => (
          <motion.div
            key={index}
            ...
            whileHover={{ y: -10, scale: 1.02 }}
            className="mx-auto flex h-[520px] w-full flex-col justify-between rounded-[31.28px] px-6 py-10 shadow-lg md:p-8"
            style={{ background: feature.bgColor }}
          >
            <div
              style={{ background: feature.elipse }}
